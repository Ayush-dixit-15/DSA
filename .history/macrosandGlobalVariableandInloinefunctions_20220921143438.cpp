...
void print(int arr[], int size, int start =0){
    // the start initialised here is a default or we can say is an optional argument which may/maynot be passed it is not mandatory if nit passed, thevalue 0 wil
