...
cout<<m["unknown key"]<<endl;
cout<<m.at("unknown key")<<endl;
// if these two functions are used simultaneously, it will first create an entry and since a new entry has been created, the later function will also show 0 as the answe
return 0;
}