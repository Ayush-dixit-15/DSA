...
void print(int arr[], int size, int start =0){
    ...
    // second thing the default value process starts from the very right of the arguments that means you cannot make an argumnet default wothout making its right argument dr
