...
//         return answer;
// }
//  yhaa pe hme product aur sum of the digits ke difference ko nikaalna tha jiske lie hme digits chahhie. To digit nikaalne ke lie pehle hm number ko modulus 10 krenge for example agar 
