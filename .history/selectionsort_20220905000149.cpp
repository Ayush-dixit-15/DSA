...
// in this type of sorting technique, we seek to find the fimd the smalest element in an array and place it on the leftmost part of the array. First at i =0 , we will search for the minimum value of the elements present inthe array an