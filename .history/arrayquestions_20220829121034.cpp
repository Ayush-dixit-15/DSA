...
//                 this is way to print in a vector
            arr2[j] = -1;
            // this is done to change the value of matched elelment so that of there is another same value in the second array, it doesnt gets matched with the sam enumber
                break;
           }
        }
    }
