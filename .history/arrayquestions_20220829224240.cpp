...
//     return ans;
// }
// in this answer while traversing the array from the first element to the last one , another loop is also made to work from i+1 that checks whether the sum of the any other elelment in the array with the one on whoch the array currently is is equal to S