...
//     return ans;
// }
// in this answer while traversing the array from the first element to the last one , another loop is also made to work from i+1 that checks whether the sum of the two elements