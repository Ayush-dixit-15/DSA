...
//  return 0;
//  }
// break statement makes you get out of the loop or the condition whichever specified

// continue statement skips a particular iteration
// leetcode question 1;
// question is to print the difference of product and the sum of a given number
...
//         return answer;
// }
//  yhaa pe hme product aur sum of the digits ke difference ko nikaalna tha jiske lie hme digits chahhie. To digit nikaalne ke lie pehle hm number ko modulus 10 krenge for example agar number 234 hai to modulus 10 aayega 4 aur wo product aur sum me apne hissab se adjust ho jayega. phir number km krne ke lie  n =n/10 yaa 234/10 jo 23 dega jise phir pehle modulo aur phir divide krke hm digits paa jayenge


// another question is to count the number of one in the given number
    //   int count =0;
    //     while (n!=0){
    //         if(n&1){
    //             count ++;
    ...
    //     }
    //     return count;
    // to yha oe hm n ko tn tk right shift krnege jb tk ki wo 0 naa ho jaaye aur agr last me 1 aauega to count 1 bdh jaayega