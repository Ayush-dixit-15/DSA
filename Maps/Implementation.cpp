...
// here the type of map used is the unorderd one so the iterator would print the map without any sequence whreas if we would have created an ordered map it would pe printed accordng to the order in which the elements were inserted in the map
return 0;
}